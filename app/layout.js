...
export default function RootLayout({ children }) {
  ...
  useEffect(() => {
    ...
    // Close any open offcanvas (except filterShop which should stay open)
    const offcanvasElements = document.querySelectorAll(".offcanvas.show");
    offcanvasElements.forEach((offcanvas) => {
      // Don't close the filterShop offcanvas - user will close it manually
      if (offcanvas.id === "filterShop") {
        return;
      }
